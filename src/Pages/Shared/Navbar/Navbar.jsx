  ...
  return (
    <>
      <div className="lg:flex justify-between items-center bg-[#E9BA48] text-sky-700 text-center space-y-2 lg:space-y-0">
        <p className="inline-flex items-center ml-5 mt-2 lg:mt-0">
          <FaPhoneAlt /> +8801941238258
        </p>
        <p className="inline-flex items-center gap-2">
          <FaRegEnvelope /> soutammollick829@gmail.com
        </p>
        <div className="flex gap-5 ml-32 lg:ml-0">
          ...
          <a
            href="https://www.linkedin.com/in/soutam-mallick-158897285/"
            target="blank"
          >
            <FaLinkedin className="text-3xl hover:text-white" />
          </a>
          <a
            href="https://github.com/soutammollick829?tab=repositories"
            target="blank"
          >
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 items-center">
            ...
            <label className="swap swap-rotate">
              ...
              <input onClick={handelDarkMood} type="checkbox" />
